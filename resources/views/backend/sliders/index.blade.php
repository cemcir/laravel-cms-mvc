                        ...
                        <tbody id="sortable">
                            @foreach($data['slider'] as $sliders)
                                <tr id="item-{{$sliders->id}}">
                                    <td class="sortable" width="150"><img width="150" height="100" src="/images/sliders/{{$sliders->slider_file}}" alt=""></td>
                                    <td>{{$sliders['slider_title']}}</td>
                                    <td width="5"><a href="{{route('slider.edit',$sliders->id)}}"><i class="fa fa-pencil-square"></i></a></td>
                                    <td width="5"><a href="javascript:void(0)"><i id="@php echo $sliders->id @endphp" class="fa fa-trash-o"></i></a></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </thead>
