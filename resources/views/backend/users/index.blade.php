                ...
                <table class="table table-striped">
                    <thead>
                        ...
                        <tbody id="sortable">
                            ...
                            <tr id="item-{{$user->id}}">
                                <td class="sortable" width="150"><img width="100" height="120" src="/images/users/{{$user->user_file}}"/></td>
                                <td>{{$user->name}}</td>
                                <td width="5"><a href="{{route('user.edit',$user->id)}}"><i class="fa fa-pencil-square"></i></a></td>
                                <td width="5"><a href="javascript:void(0)"><i id="@php echo $user->id @endphp" class="fa fa-trash-o"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </thead>
